...
PreApproach::PreApproach(const rclcpp::NodeOptions &options)
  ...
  scan_sub = this->create_subscription<sensor_msgs::msg::LaserScan>(
      "scan", 10, std::bind(&PreApproach::scan_callback, this, _1), options1);

  odom_sub = this->create_subscription<nav_msgs::msg::Odometry>(
      "odom", 10, std::bind(&PreApproach::odom_callback, this, _1), options2);
...
void PreApproach::second_step_pre_approach(double starting_angle) {
