...
int main(int argc, char *argv[]) {
  ...
  // Add some nodes to the executor which provide work for the executor
  //  during its "spin" function. An example of available work is executing
  // a subscription callback, or a timer callback.
